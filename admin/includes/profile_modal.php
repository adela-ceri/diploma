    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Perditeso Profilin</b></h4>
          	</div>
          	...
          	<div class="modal-footer">
            	...
            	<button type="submit" class="btn btn-success btn-flat" name="save"><i class="fa fa-check-square-o"></i> Perditeso</button>
            	</form>
          	</div>
        </div>
    </div>
